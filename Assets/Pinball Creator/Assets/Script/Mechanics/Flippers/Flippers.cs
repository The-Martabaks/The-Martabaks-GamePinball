...
public class Flippers : MonoBehaviour {
	...
	public bool 						Activate = true;				// Know if the flipper is activated or not
	...
	public void  F_Desactivate(){if(!b_Debug)Activate = true;}								// --> Deactivate the flipper	. Call by Manager_Game.js on game object Manager_Game on the hierarchy
